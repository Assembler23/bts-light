...
!macro NSIS_HOOK_POSTINSTALL
  ...
  DetailPrint "Firewall-Regel fuer den verschluesselten Zugang (Port 8443) wird angelegt ..."
  ExecShellWait "runas" "netsh.exe" 'advfirewall firewall add rule name="BTS Light (Tablets, verschluesselt)" dir=in action=allow protocol=TCP localport=8443 enable=yes profile=any' SW_HIDE

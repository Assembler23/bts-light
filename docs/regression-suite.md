...
| **Datensparsamkeit der Turnierleitungs-Ansicht**: der ausgelieferte Zustand enthält weder Lizenznummer noch Geburtsjahr, Nationalität, Akkustand oder Aufschlag-Anzeige | `tablet/tl.rs` — `the_state_never_carries_personal_data_beyond_its_purpose` |

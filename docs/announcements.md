...
`CloudAnnounceCourt` (`commands.rs`) ließ sie fallen. Beide Schalter wirken am
Slave jetzt genauso wie am Master. Wächter: `die_ferne_halle_bekommt_auch_die_besetzung`. Segment- und SSML-Bauer nutzen dieselbe Quelle
